...
const samplePosts: BlogPost[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1669986480140-2c90b8edb443?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmF2ZWwlMjBhZHZlbnR1cmUlMjBtb3VudGFpbnxlbnwxfHx8fDE3Njc2MTE0OTR8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    id: "5",
    title: "リモートワークで見つけた新しい朝のルーティン",
    excerpt:
      "フルリモートワークになって1年。試行錯誤の末に辿り着いた、生産性を高める朝の習慣について紹介します。",
    content:
      "リモートワークになってから、朝の時間の使い方が大きく変わりました。通勤時間がなくなったことで、朝の2時間をどう使うかが生産性を大きく左右することに気づきました。\n\n私の朝は6時に起きることから始まります。まずは15分間の軽いストレッチで体を目覚めさせます。その後、コーヒーを淹れながら、今日のタスクを頭の中で整理します。このコーヒータイムが、1日の中で最も大切な時間になっています。\n\n7時からは読書の時間。技術書や小説など、その日の気分で選びます。知識をインプットする時間を朝に持つことで、頭がクリアな状態で学習できます。8時には軽い朝食を取り、8時半から仕事を開始します。\n\nこのルーティンを続けることで、以前よりも心身ともに健康になり、仕事のパフォーマンスも向上しました。朝の時間を大切にすることの重要性を、身をもって実感しています。",
    author: "小林大洋",
    date: "2024-11-20",
    readTime: "4分",
    category: "lifestyle",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1758520706103-41d01f815640?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxydW5uaW5nJTIwZml0bmVzc3xlbnwxfHx8fDE3Njc1NzAwNDl8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    id: "8",
    title: "週末の料理実験：初めてのパン作りに挑戦",
    excerpt:
      "在宅時間が増えたことをきっかけに始めた料理。今回は念願のパン作りに初挑戦しました。",
    content:
      "週末を使って、以前から興味があったパン作りに挑戦してみました。プログラミングと同じで、レシピという「コード」に従って実行すれば成功するはず…と思っていたのですが、そう簡単ではありませんでした。\n\n材料は至ってシンプル。強力粉、イースト、塩、砂糖、水だけ。しかし、こねる時間、発酵の温度、焼き時間など、様々な変数が絡み合います。まるで複雑なアルゴリズムを最適化するような作業でした。\n\n1回目は完全に失敗。発酵が不十分で、石のように硬いパンができあがりました。2回目は発酵させすぎて、逆にベタベタに。3回目でようやく、それらしい形のパンを焼くことができました。\n\nパン作りを通じて、「試行錯誤の大切さ」を改めて実感しました。失敗から学び、少しずつ改善していく。これはエンジニアリングにも通じる考え方です。次回はクロワッサンに挑戦したいと思います。",
    author: "小林大洋",
    date: "2024-07-28",
    readTime: "4分",
    category: "lifestyle",
    tags: ["料理", "パン作り", "週末", "DIY"],
    imageUrl:
      "https://images.unsplash.com/photo-1514986888952-8cd320577b68?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb29raW5nJTIwZm9vZHxlbnwxfHx8fDE3Njc1MjA5Nzh8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    id: "9",
    title: "写真を始めて見えてきた、新しい世界の切り取り方",
    excerpt:
      "カメラを手にして半年。写真を通じて見える世界が変わりました。技術と感性の両面から楽しむ趣味について。",
    content:
      "今年の初めに一眼レフカメラを購入してから、約半年が経ちました。最初は「良い写真を撮りたい」という単純な動機でしたが、今では写真が私の生活に欠かせないものになっています。\n\nカメラを持ち歩くようになってから、日常の何気ない風景に美しさを見出すようになりました。朝の光、雨上がりの街並み、カフェの窓から差し込む陽射し。以前は気づかなかった小さな瞬間に、シャッターを切る喜びを感じています。\n\n技術的な面でも学ぶことが多く、露出、シャッタースピード、ISO感度など、様々なパラメータを調整して理想の1枚を追求する過程は、プログラミングのデバッグ作業に似ています。試行錯誤しながら最適解を見つけていく感覚が楽しいです。\n\n最近は週末に街を歩きながらのスナップ撮影にハマっています。被写体を探しながら歩くことで、運動にもなり、新しい場所の発見にもつながります。来月は紅葉を撮りに京都へ行く予定です。",
    author: "小林大洋",
    date: "2024-06-15",
    readTime: "4分",
    category: "hobby",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1622319977720-9949ac28adc4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaG90b2dyYXBoeSUyMGNhbWVyYXxlbnwxfHx8fDE3Njc1NTI1MDh8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    id: "11",
    title: "おすすめ音楽",
    excerpt: "最近ハマっている音楽を紹介",
    content: "羊文学がいいです。",
    author: "小林大洋",
    date: "2026-01-07",
    readTime: "1分",
  ...
  },
  {
    ...
    excerpt: "気づき",
    content:
      "仕事でうまくいくと嬉しい。\nうまくいかないと落ち込む。\nつまりこれは自分が何かに社会に貢献した時に喜びを感じるということ。\nつまり仕事は何かしら貢献することで幸せを実感するためにやっているのではと最近思う。\nもちろんお金をもらうためにやっているのも間違いはないが、ただそれだけではない。間違いなく。\n人は一人では生けて行けない。何かしらのコロニーに属しそこで貢献する。\nそれは人間にとって生きる理由そのものだ。",
    author: "小林大洋",
    date: "2026-01-20",
    readTime: "1分",
    category: "lifestyle",
